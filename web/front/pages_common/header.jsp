...
<head>
    ...
    <!--[if IE 6]>
    <script src="${ctx}/frontjs/iepng.js" type="text/javascript"></script>
    <script type="text/javascript">
    ...
    <script type="text/javascript" src="${ctx}/front/js/n_nav.js"></script>
    <script type="text/javascript" src="${ctx}/front/js/milk_ban.js"></script>
    <script type="text/javascript" src="${ctx}/front/js/paper_ban.js"></script>
    <script type="text/javascript" src="${ctx}/front/js/baby_ban.js"></script>
